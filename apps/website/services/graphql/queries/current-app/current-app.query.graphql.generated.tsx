...
export type CurrentGlobalAppQuery = {
  __typename?: "Query";
  currentApp: {
    __typename?: "App";
    id: string;
...
export function useCurrentGlobalAppQuery(
  options?: Omit<Urql.UseQueryArgs<CurrentGlobalAppQueryVariables>, "query">
) {
  return Urql.useQuery<CurrentGlobalAppQuery, CurrentGlobalAppQueryVariables>({
