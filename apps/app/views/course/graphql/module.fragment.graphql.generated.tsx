...
export type CoursePageModuleVideoFragment = { __typename?: 'Video', id: string, name: string, private: boolean, active: boolean, file?: { __typename?: 'File', url?: string | null, duration?: number | null } | null };
