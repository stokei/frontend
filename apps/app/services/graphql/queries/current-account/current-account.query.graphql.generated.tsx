...
export type CurrentAccountQuery = { __typename?: 'Query', me: { __typename?: 'MeAccount', id: string, isAdmin?: boolean | null, firstname: string, lastname: string, fullname: string, isStokei: boolean, email: string, username: string, status: Types.AccountStatus, createdAt?: string | null, avatar?: { __typename?: 'Image', file: { __typename?: 'File', url?: string | null } } | null } };
