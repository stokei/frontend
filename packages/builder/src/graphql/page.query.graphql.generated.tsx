...
export type GetPageQuery = { __typename?: 'Query', page: { __typename?: 'Page', id: string, title: string, type: Types.PageType, url?: string | null, slug: string, parent: string, app?: { __typename?: 'App', id: string } | null } };
