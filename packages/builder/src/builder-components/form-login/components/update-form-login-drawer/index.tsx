...
import { FormLoginData } from "../../hooks/use-data-to-props";

interface UpdateFormLoginDrawerProps {
  id: string;
  currentData?: FormLoginData;
  isOpen?: boolean;
  onUpdate?: (data?: FormLoginData) => void;
  onClose: () => void;
}

export const UpdateFormLoginDrawer = ({
  id,
  isOpen,
  currentData,
  onClose,
  onUpdate,
}: UpdateFormLoginDrawerProps) => {
