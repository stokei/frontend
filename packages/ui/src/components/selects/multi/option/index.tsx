...
export interface MultiSelectOptionProps<TValue = any> extends BoxProps {
    value: TValue
}
export const MultiSelectOption = ({ value, children, ...props }: PropsWithChildren<MultiSelectOptionProps>) => {
    const {
        value: currentItem,
        isLoading,
        isDisabled,
